...
envoy_cc_binary(
    ...
    deps = [
        ...
        "//src/envoy/metadata_to_peer_node:config_lib", # acmg
        "//src/envoy/workload_metadata:config_lib", # acmg
        "//src/envoy/tls_passthrough:filter_lib", # acmg
        "//src/envoy/http/baggage_handler:config_lib", # acmg
